...
<body <?php body_class('bg-primary text-text-color antialiased font-montserrat');?>>
    ...
    <header id="header-data"
        class="bg-opacity-0 h-[50px] md:h-[70px] bg-primary text-text-color text-sm fixed inset-0 z-999 leading-5 p-0 text-left transition-all duration-200 <?php if (is_admin_bar_showing()) {echo "mt-[2.875rem] lg:mt-8";}?>">
    ...
    <div data-sidebar
        ...
        <div data-default-header class="mt-5 min-h-full">
