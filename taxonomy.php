...
$animes   = new Kira_Query(['paged' => $page, 'tax_query' => ['relation' => 'AND', ['taxonomy' => $tax_name, 'field' => 'term_id', 'terms' => [$id], 'operator' => 'IN']], 'posts_per_page' => get_theme_mod('__archive_count', 20)]);
?>
...
?>
    ...
    <aside class="w-full p-4 mt-5 lg:mt-0 sidebar-width">
